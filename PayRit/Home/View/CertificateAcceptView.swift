...
//                                        .font(Font.body04)
//                                    Spacer().frame(width: 70)
//                                    Text("\(homeStore.certificates[index].specialConditions ?? "")")
//                                        .font(Font.body01)
//                                    Spacer()
//                                }
//                            }
...
//                }
//                VStack {
//                    if homeStore.certificates[index].state == .waitingApproval {
//                        Button {
...
//                        }
//                        .disabled(!checkBox)
//                    } else if homeStore.certificates[index].state == .waitingPayment {
//                        Button {
//                            homeStore.certificates[index].state = .progress
//                            dismiss()
//                        } label: {
//                            Text("결제 하기")
//                                .font(Font.title04)
